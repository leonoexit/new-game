...
Format: <horizontal 8:5 for action/plot art; square 1:1 for portrait/item art>
...
- Inferring portrait artwork from a portrait phone or portrait card creates the wrong asset. Action artwork uses the measured horizontal 8:5 illustration window.
